...
export class HomePage {
  // criou uma variavel de instacia e instanciou
  public livros: Livro[];
  ...
  irParaDestino(livro:Livro):void{
    this.navCtrl.push(DestinoPage, {livroSelecionado: livro});//navctrl > atributo .....tem o metodo push...vai mandar para o Destino Page Passando como paramentro livro selecionado
    }
